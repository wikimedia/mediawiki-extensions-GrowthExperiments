...
require( './help/ext.growthExperiments.HelpPanelLogger.test.js' );
require( './help/ext.growthExperiments.HelpPanelProcessDialog.test.js' );
require( './help/ext.growthExperiments.HelpPanelProcessDialog.SwitchEditorPanel.test.js' );
