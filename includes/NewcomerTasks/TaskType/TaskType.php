...
class TaskType implements JsonUnserializable {
	...
	/** @var bool Whether this is a task type generated by machine */
	protected $isMachineSuggestion = false;

	/** @var bool Whether this is a task type is only available on mobile */
	protected $isMobileOnly = false;
	...
	public function getIconData(): array {
		$descriptionMessageKey = $this->isMobileOnly ?
